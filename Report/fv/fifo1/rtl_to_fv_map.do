...
# Generated on: Wed Aug 13 22:13:24 IST 2025 (Wed Aug 13 16:43:24 UTC 2025)
...
set logfile fv/fifo1/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fifo1 -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/vlsi/cad/cadence/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/vlsi/cad/cadence/GENUS211/tools.lnx86"
set env(CW_DIR) "/vlsi/cad/cadence/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/vlsi/cad/cadence/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /vlsi/cad/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/vlsi/cad/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/vlsi/cad/cadence/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/vlsi/cad/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/vlsi/cad/cadence/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path ../../../../../../../vlsi/pdk/tsmc_gp_65_stdio/tcbn65gplus_200a/TSMCHOME/digital/Front_End/timing_power_noise/CCS/tcbn65gplus_200a/ -library -both
read_library -liberty -both \
    /home/users/prabhakar/work_tsmc_gp_65/self_project/rough/report/../../../../../../../vlsi/pdk/tsmc_gp_65_stdio/tcbn65gplus_200a/TSMCHOME/digital/Front_End/timing_power_noise/CCS/tcbn65gplus_200a/tcbn65gpluswc_ccs.lib \
    /home/users/prabhakar/work_tsmc_gp_65/self_project/rough/report/../../../../../../../vlsi/pdk/tsmc_gp_65_stdio/tcbn65gplus_200a/TSMCHOME/digital/Front_End/timing_power_noise/CCS/tcbn65gplus_200a/tcbn65gplusbc_ccs.lib \
    /home/users/prabhakar/work_tsmc_gp_65/self_project/rough/report/../../../../../../../vlsi/pdk/tsmc_gp_65_stdio/tcbn65gplus_200a/TSMCHOME/digital/Front_End/timing_power_noise/CCS/tcbn65gplus_200a/tcbn65gplustc_ccs.lib
...
add_search_path ../code/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../code/fifo_1.v
elaborate_design -golden -root {fifo1} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fifo1/fv_map.v.gz
elaborate_design -revised -root {fifo1}
...
#add_name_alias fv/fifo1/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.fifo1.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fifo1.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fifo1.rtl.fv_map.rpt
